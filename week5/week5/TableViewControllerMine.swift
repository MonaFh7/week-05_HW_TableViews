...
let myArray = [["ABHA", "RIYADH", "MEKKAH"], ["TABUK", "JEDDAH", "KHOBAR"]]
let mySection = ["Citites visited", "Cities want to visit"]
...
class TableViewControllerMine: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = UITableViewCell(style: .value2, reuseIdentifier: "mycell")
